...
//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	if (empty($_POST['Name2'])){
		$errors[] = "Ingresa el nombre de Categoría.";
	} 
	elseif (!empty($_POST['Name2']))
	{
		...
		$url = $urlServicios."api/efectividad/revisarnombre.php?nombre=$nombre&ck=$CustomerKey&id=0";
		...
		else
		{
			...
			$url = $urlServicios."api/efectividad/crear.php?$params";			
			//echo $url;
			$query = "";
			$resultado = "";
			$ch = curl_init();
