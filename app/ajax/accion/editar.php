...
elseif (!empty($_POST['edit_id']))
{
	...
	$accionnombre = trim($_POST["edit_name"]);
	...
	$url = $urlServicios."api/accion/revisarnombre.php?nombre=$accionnombre&id=$id";
	...
	{		
		...
		$params = "NombreAccion=$accionnombre&Estado=$estado&Id=$id";
		$url = $urlServicios."api/accion/update.php?$params";
		//echo "url...$url";
