...
elseif (!empty($_POST['edit_id']))
{
	...
	$rangoini = trim($_POST["edit_rangoini"]);
	...
	{		
		...
		$params = "Nombre=$nombre&RangoIni=$rangoini&RangoFin=$rangofin&Color=$color&Id=$id";
		$url = $urlServicios."api/calificacion/update.php?$params";
		//echo "url...$url";
