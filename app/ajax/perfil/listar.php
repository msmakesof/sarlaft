			...
			<tbody>	
				...
				{	
					if( $data["itemCount"] > 0)
					{
						...
						{
							$id = $data['body'][$i]['IdPerfil'];
							$NombrePerfil = trim($data['body'][$i]['NombrePerfil']);
				...
				<tr class="<?php echo $text_class;?>">
					...
					<td class='text-left'><?php echo $NombrePerfil; ?></td>
					<td class='text-center'><?php echo $STA_Nombre; ?></td>
					<td class='text-right'>
						<a href="#" data-target="#editUserModal" class="edit" data-toggle="modal" data-name="<?php echo $NombrePerfil; ?>" data-estado="<?php echo $UserStatus; ?>" data-id="<?php echo $id; ?>"><i class="material-icons" data-toggle="tooltip" title="Editar" >&#xE254;</i></a>
