...
{	
	...
	$Interno = trim($_POST["eInterno"]);
	//$nombre = str_replace(' ','%20',strtoupper($nombre));
	$Externo = $_POST["eExterno"];	
	...
	$url = $urlServicios."api/contexto/revisarnombre.php?interno=$Interno&externo=$Externo&id=$id";
	...
	{		
		...
		*/
		...
		$sql = "UPDATE CTX_Contexto SET CTX_Interno= '". htmlspecialchars(strip_tags($Interno)) ."', CTX_Externo='". htmlspecialchars(strip_tags($Externo)) ."' WHERE CTX_IdContexto = $id ";
