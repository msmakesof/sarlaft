...
//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	if (empty($_POST['Name2'])){
		$errors[] = "Ingresa el nombre de Probabilidad.";
	} 
	elseif (!empty($_POST['Name2']))
	{
		...
		$url = $urlServicios."api/consecuencia/revisarnombre.php?nombre=$nombre&ck=$CustomerKey&id=0";
		...
		else
		{
			...
			$params = "Nombre=$nombre&Escala=$escala&Color=$color&CK=$CustomerKey&UK=$UserKey";
			$url = $urlServicios."api/consecuencia/crear.php?$params";			
			//echo $url;
			$query = "";
			$resultado = "";
			$ch = curl_init();
