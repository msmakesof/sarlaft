...
elseif (!empty($_POST['edit_id']))
{
	...
	$url = $urlServicios."api/consecuencia/revisarnombre.php?nombre=$nombre&ck=$ck&id=$id";
	...
	{		
		...
		$params = "Nombre=$nombre&Escala=$escala&Color=$color&Id=$id";
		$url = $urlServicios."api/consecuencia/update.php?$params";
		//echo "url...$url";
