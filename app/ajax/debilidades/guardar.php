...
if (empty($_POST['DebilidadName2'])){
	$errors[] = "Ingresa el nombre de la Debilidad.";
} 
elseif (!empty($_POST['DebilidadName2']))
{		
	...
	$nombre = trim($_POST["DebilidadName2"]);
	...
	$url = $urlServicios."api/debilidades/revisarnombre.php?nombre=$nombre&ck=$CustomerKey&id=0";
	//echo $url;
	...
	{		
		...
		$url = $urlServicios."api/debilidades/crear.php?$params";			
