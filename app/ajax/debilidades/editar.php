...
{	
	...
	$url = $urlServicios."api/debilidades/revisarnombre.php?nombre=$nombre&ck=$ck&id=$id";
	...
	{		
		...
		$params = "Nombre=$nombre&ck=$ck&Id=$id";
		$url = $urlServicios."api/debilidades/update.php?$params";
		//echo "url...$url";
