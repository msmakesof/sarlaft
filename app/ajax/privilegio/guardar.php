...
//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	if (empty($_POST['UserName2'])){
		$errors[] = "Ingresa el nombre del Perfil.";
	} 
	...
	{		
		...
		$perfilnombre = trim($_POST["UserName2"]);
		...
		$url = $urlServicios."api/perfil/revisarnombre.php?nombre=$perfilnombre&id=0";
		...
		{		
			...
			$params = "NombrePerfil=$perfilnombre&Estado=$estado";
			$url = $urlServicios."api/perfil/crear.php?$params";			
