	...
	?>
				...
				<tbody>	
						...
						<tr class="<?php echo $text_class;?>">
							...
							<td class='text-left'>
								<a href="#"  data-target="#editDebilidadesModal" class="edit" data-toggle="modal" data-name="<?php echo $FactorRiesgoName?>"  data-id="<?php echo $id; ?>"><i class="material-icons" data-toggle="tooltip" title="Editar" >&#xE254;</i></a>
