...
elseif (!empty($_POST['edit_id']))
{
	...
	$menunombre = trim($_POST["edit_name"]);
	...
	$url = $urlServicios."api/menu/revisarnombre.php?nombre=$menunombre&id=$id";
	...
	{		
		...
		$params = "NombreMenu=$menunombre&Estado=$estado&Id=$id";
		$url = $urlServicios."api/menu/update.php?$params";
		//echo "url...$url";
