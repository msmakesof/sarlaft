...
?>
			...
			<tbody>	
				...
				{	
					if( $data["itemCount"] > 0)
					{
						for($i=0; $i<count($data['body']); $i++)
						{
							...
							$UserStatus = $data['body'][$i]['OPC_IdEstado'];
				...
				<tr class="<?php echo $text_class;?>">
					...
					<td class='text-left'><?php echo $NombreMenu; ?></td>
					<td class='text-center'><?php echo $STA_Nombre; ?></td>
					<td class='text-right'>
						<a href="#" data-target="#editUserModal" class="edit" data-toggle="modal" data-name="<?php echo $NombreMenu; ?>" data-estado="<?php echo $UserStatus; ?>" data-id="<?php echo $id; ?>"><i class="material-icons" data-toggle="tooltip" title="Editar" >&#xE254;</i></a>
