...
//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	if (empty($_POST['Name2'])){
		$errors[] = "Ingresa el nombre de Control.";
	} 
	elseif (!empty($_POST['Name2']))
	{
		...
		$url = $urlServicios."api/rcontrol/revisarnombre.php?nombre=$nombre&ck=$CustomerKey&id=0";
		...
		else
		{
			...
			$url = $urlServicios."api/rcontrol/crear.php?$params";			
			//echo $url;
			$query = "";
			$resultado = "";
			$ch = curl_init();
