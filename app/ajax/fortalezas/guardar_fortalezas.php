...
if (empty($_POST['FortalezasName2'])){
	...
	$query=sqlsrv_query($conn,"SELECT count(id) as Total FROM FortalezasSarlaft WHERE CustomerKey=".$_SESSION['Keyp']." AND FortalezasName ='".trim($_POST['FortalezasName2'])."'");
	...
	if( $reg['Total'] > 0 ){
		...
		$FortalezasName=trim(strtoupper($_POST["FortalezasName2"]));
