<?php
    class SegCanales{
        ...
        // Table
        private $db_table = "SegCanalesSarlaft";

        // Columns
		public $id;
		public $CustomerKey;
		public $SegCanalesName;
        public $UserKey;
        public $DateStamp;
        ...
        public function getAccion(){
            $sql = "SELECT id, CustomerKey, SegCanalesName, UserKey FROM ". $this->db_table ." 
            ORDER BY SegCanalesName ";            
        ...
        public function getCkAll(){
            $sql = "SELECT id, CustomerKey, SegCanalesName, UserKey
            FROM ". $this->db_table ." WHERE CustomerKey = ? ORDER BY SegCanalesName ";
            //echo $sql;
			$stmt = $this->conn->prepare($sql, array(PDO::ATTR_CURSOR => PDO::CURSOR_SCROLL));
