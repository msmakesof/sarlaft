<?php
    class Consecuencias{
        ...
        // Table
        private $db_table = "ConsecuenciasSarlaft";

        // Columns
		public $id;
		public $CustomerKey;
        public $ConsecuenciasKey;
		public $ConsecuenciasName;
        public $UserKey;
        public $DateStamp;
        ...
        public function getAccion(){
            $sql = "SELECT id, CustomerKey, ConsecuenciasKey, ConsecuenciasName, UserKey FROM ". $this->db_table ." 
             ORDER BY ConsecuenciasName ";            
        ...
        public function getCkAll(){
            $sql = "SELECT id, CustomerKey, ConsecuenciasKey, ConsecuenciasName, UserKey
            FROM ". $this->db_table ." WHERE CustomerKey = ? ORDER BY ConsecuenciasName ";
            //echo $sql;
			$stmt = $this->conn->prepare($sql, array(PDO::ATTR_CURSOR => PDO::CURSOR_SCROLL));
