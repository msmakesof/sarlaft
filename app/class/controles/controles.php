<?php
    class Controles{
        ...
        public function getAccion(){
            $sql = "SELECT id, CustomerKey, ControlesName, UserKey, ControlesKey, DateStamp FROM ". $this->db_table ." 
            ORDER BY ControlesName ";            
        ...
        public function getCkAll(){
            $sql = "SELECT id, CustomerKey, ControlesName, UserKey, ControlesKey, DateStamp 
