<?php
    class Tratamiento{
        ...
        // Table
        private $db_table = "TratamientosSarlaft";

        // Columns
		public $id;
		public $CustomerKey;
		public $TratamientosKey;
        public $TratamientosName;
        public $UserKey;
        public $DateStamp;
        ...
        public function getAll(){
            $sql = "SELECT id, CustomerKey, TratamientosName, UserKey, TratamientosKey, DateStamp 
            FROM ". $this->db_table ." ORDER BY TratamientosName";
            //echo $sql;
        ...
        public function getCkAll(){
            $sql = "SELECT id, CustomerKey, TratamientosName, UserKey, TratamientosKey, DateStamp 
            FROM ". $this->db_table ." WHERE CustomerKey = ? ORDER BY TratamientosName ";
            //echo $sql;
			$stmt = $this->conn->prepare($sql, array(PDO::ATTR_CURSOR => PDO::CURSOR_SCROLL));
