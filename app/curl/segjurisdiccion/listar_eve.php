	...
	<tr>
		<td style="width:10%">
			<div id="addsju" style="float:left">
				<i class="fas fa-plus-circle fa-1x" data-toggle="tooltip" title="Adicionar Segmento Jurisdicción" style="color:green; cursor:pointer"></i>
			</div>

			<a href="#" id="mcreasca" style="float:right" data-target="#addSegJurisdiccionModal" data-toggle="modal" data-ck="<?php echo $CustomerKey;?>">
				<i class="fas fa-file-alt fa-1x" data-toggle="tooltip" title="Crear Segmento Jurisdicción" style="color:orange; cursor:pointer"></i>
			</a>
		</td>
