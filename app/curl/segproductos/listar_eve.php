	...
	<tr>
		<td style="width:10%">
			<div id="addspr" style="float:left">
				<i class="fas fa-plus-circle fa-1x" data-toggle="tooltip" title="Adicionar Segmento Productos" style="color:green; cursor:pointer"></i>
			</div>

			<a href="#" id="mcreacau" style="float:right" data-target="#addSegProductosModal" data-toggle="modal" data-ck="<?php echo $CustomerKey;?>">
				<i class="fas fa-file-alt fa-1x" data-toggle="tooltip" title="Crear Segmento Productos" style="color:orange; cursor:pointer"></i>
			</a>
		</td>
		<td style="width:80%"><label>Segmento Productos</label></td>
		<td style="width:10%"></td>
	</tr>
	</thead>
	<tbody id="tabsprbody"></tbody>
</table>