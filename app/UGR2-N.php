...
<body id="page-top">
<form method="post" id="formularioN">              
<headers>
   <?php include 'components/topbarugr.php';?><div id="respN"></div><button type="button" id="btn-ingresarN" >Grabar</button>
   <?php include 'components/DB-Evento_Riesgo.php';?> 
    ...
    <?php include 'components/DB-Detalle_Riesgo.php';?>
