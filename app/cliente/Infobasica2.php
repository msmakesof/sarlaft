        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!--<div class="my-summernote" id="summernote1">summernote 1</div>
                    <div class="my-summernote" id="summernote2">summernote 2</div>-->



  <textarea id="summernote" name="editordata"></textarea>

                    <div class="summernote">summernote 3</div>
                    <div class="summernote">summernote 4</div> 
            ...
            $("#guardar").on('click', function(event){
                ...
                if( nombre == "" ){
					swal({
						position: 'top-end',
						type: 'info',
						title: 'Debe ingresar información en la descripción de la Tarea.',
