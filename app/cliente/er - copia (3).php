    ...
    <script>
        ...
        $(document).ready(function(){
			...
			$("#prob1").on('change', function(){
				...
				//$("#lblprob").html(txt);
				alert( $(this).val() );
				//$.get("../curl/matriz/listar_eve1.php", {'ck': <?php echo $CustomerKey; ?>, 'pfila': txt }, function(result){
				//	alert(result);
				//	//$("#parmatriz").load(" #parmatriz");
				//	$("#parmatriz").load("../curl/matriz/listar_eve1.php");
				//})
				
				var paramet = "ck="+<?php echo $CustomerKey; ?>+"&pfila="+txt;
				alert(paramet);
				$.ajax({
                    type: "POST",
                    url: "../curl/matriz/listar_eve1.php",
					data: paramet,
                    success: function(datos){
                        alert(datos);
						//$("#parmatriz").load(" #parmatriz");
						$("#parmatriz").html(datos);
						//load("../curl/matriz/listar_eve1.php");
                    }	
                })
			})
