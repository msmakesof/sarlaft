...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Metodología</h1>
                    <p class="mb-4"></p>
                    ...
                    <div class="card shadow mb-4">
						...
						{							
							...
							{
								$MetodId=trim($data['body'][$i]['MET_IdMetodologia']);
								$MetodFactorRiesgo=trim($data['body'][$i]['MET_FactorRiesgo']);
								$MetodName=trim($data['body'][$i]['MET_Nombre']);
								$MetodDescripcion=trim($data['body'][$i]['MET_Descripcion']);
								$MetodObservaciones=trim($data['body'][$i]['MET_Observaciones']);
								$MetodCustomerKey=trim($data['body'][$i]['MET_CustomerKey']);
								$MetodologiaKey=trim($data['body'][$i]['MET_MetodologiaKey']);
								$MetodUSerKey=trim($data['body'][$i]['MET_USerKey']); 
						?>	
						<tr>
							<td class='text-left'><?php echo $MetodFactorRiesgo;?></td>							
							<td class='text-left' ><?php echo $MetodName ;?></td>							
                        ...
                        <div class="modal-content">
                            <div class="modal-header">                            
                                <h5 class="modal-title" id="exampleModalLabel" style="color:blue;text-shadow: 0.1em 0.1em 0.2em black; font-size:24px">
                                    <i class="fas fa-address-card"></i>  Crear Metodología
                                </h5>
                            ...
                            <div class="modal-body">
                                <form id="f">
									<div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="exampleFormControlSelect1">Factor Riesgo</label>
                                            <textarea class="form-control" id="factorriesgo" name="factorriesgo" rows="2" placeholder="Digite Factor Riesgo" required></textarea >
                                        </div> 
									</div>
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label>Nombre Metodología</label>
                                            <textarea class="form-control" id="MetodologiaName2" name="MetodologiaName2" rows="2" placeholder="Digite nombre de la Metodología" required></textarea>
									...
									<div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="descripcion" name="descripcion" rows="2" placeholder="Digite Descripción" required></textarea >
                                        </div>
									</div>	
									...
									<div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="observaciones" name="observaciones" rows="2" placeholder="Digite Observaciones" required></textarea >
                                        </div>
                                    </div>                                    
                                </form>    
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" style="color:red;text-shadow: 0.1em 0.1em 0.2em black; font-size:24px">
                        <i class="far fa-edit"></i>   Editando Metodología
                    </h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <form id="ef">
						<div class="form-group row">
							<div class="col-md-12">
								<label for="exampleFormControlSelect1">Factor Riesgo</label>
								<textarea class="form-control" id="efactorriesgo" name="efactorriesgo" rows="2" placeholder="Digite Factor Riesgo" required></textarea >
							</div> 
						</div>
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label>Nombre Metodología</label>
                                <textarea class="form-control" id="eMetodologiaName2" name="eMetodologiaName2" rows="2" placeholder="Digite nombre de la Metodología" required></textarea>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
								<label>Descripción</label>                                            
								<textarea class="form-control" id="edescripcion" name="edescripcion" rows="2" placeholder="Digite Descripción" required></textarea >
							</div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-12">
								<label for="exampleFormControlSelect1">Observaciones</label>
								<textarea class="form-control" id="eobservaciones" name="eobservaciones" rows="2" placeholder="Digite Observaciones" required></textarea >
							</div>
                        </div>
                    </form>
                </div>
    ...
    <!-- Delete Modal -->
    <div id="deleteMetodologiaModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form name="delete_metodologia" id="delete_metodologia">
					<div class="modal-header">						
						<h4 class="modal-title">Eliminar Metodología</h4>
    ...
    <script>
        $(document).ready(function(){            
            ...
            $('#editModal').on('show.bs.modal', function (event) {
			    ...
			    $('#eMetodologiaName2').val(name)
                
				var efactorriesgo = button.data('factorriesgo')
                $('#efactorriesgo').val(efactorriesgo)
                
                var edescripcion = button.data('descripcion') 
			    $('#edescripcion').val(edescripcion)

                eobservaciones = button.data('observaciones')
                $('#eobservaciones').val(eobservaciones)
            ...
            $("#guardar").on('click', function(event){
                ...
                $.ajax({
					type: "POST",
					url: "../ajax/metodologia/guardar.php",
					data: parametros,
					...
					success: function(datos){
						...
						if(msj == 'O'){
							type = 'success';
							txt = 'Metodología ha sido guardada con éxito.';
						}
						else if(msj == 'E'){
							type= 'warning';
            ...
            $("#eguardar").on('click', function(event){
                ...
                $.ajax({
					type: "POST",
					url: "../ajax/metodologia/editar.php",
					data: parametros,
					beforeSend: function(objeto){
						swal({
							position: 'top-end',
					...
					success: function(datos){
						...
						if(msj == 'U'){
							type = 'success';
							txt = 'Metodología ha sido actualizada con éxito.';
						}
						else if(msj == 'E'){
							type= 'warning';
							txt = 'Ya existe un Registro grabado con el mismo Nombre.';
            ...
            $('#deleteMetodologiaModal').on('show.bs.modal', function (event) {
            ...
            $( "#borrar" ).on('click', function( event ) {
                var parametros = $("#delete_metodologia").serialize();
                $.ajax({
                    type: "POST",
                    url: "../ajax/metodologia/delete.php",
                    data: parametros,
                    beforeSend: function(objeto){
                        swal({
							position: 'top-end',
                    ...
                    success: function(datos){
                        let m= datos.trim();
                        //$("#resultados").html(datos);
                        $('#deleteMetodologiaModal').modal('hide');
                        let msj = m.substr(0,1);
                        let type;
                        let txt;
                        if(msj == 'B'){
                            type = 'success';
                            txt = 'Metodología ha sido eliminada con éxito';
                        }
                        else if(msj == 'D'){
                            type= 'error';
                            txt ='Error Desconocido.';
            ...
            $("#pdf").on('click', function(event){
                ...
                doc.autoTable({ 
                    useCORS: true,
                    columns: [
                        { header: 'Factor Riesgo', dataKey: 'MET_FactorRiesgo' },
                        { header: 'Nombre', dataKey: 'MET_Nombre' },
                        { header: 'Descripción', dataKey: 'MET_Descripcion' },
                        { header: 'Observaciones', dataKey: 'MET_Observaciones' },
                    ],
                    ...
                    didDrawPage: function (data) {					
                        ...
                        doc.setFontSize(20);
                        doc.setTextColor(40);
                        doc.text("Reporte de Metodologia", data.settings.margin.left+190, 40);
