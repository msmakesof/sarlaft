...
?>
    ...
    <script>
		...
		function fnCategoria(pValue, pidSelect){
			...
			//if($('#clonmatriz').css('display') == 'none'){
			var isVisible = $("#clonmatriz").is(":visible");
			alert('visible en Categoria? '+isVisible);
			if( isVisible ){
			   // Acción si el elemento no es visible
			    posinifils = $("#prob1").find('option:selected').val();
				posinicols = $("#consec1").find('option:selected').val();
			}else{
				// Acción si el elemento es visible
				//posinifils = <?php echo $PosicioActualFils ;?>;
				//posinicols = <?php echo $PosicioActualCols ;?>;
			}
			
			fnMatRiesgo(moverbolita,posinifils,posinicols,moverfils,movercols,posicionesmover)
		}
		...
		function fnRealizado(pValue, pidSelect){
			...
			//if($('#clonmatriz').css('display') == 'none'){
			var isVisible = $("#clonmatriz").is(":visible");
			alert('visible en Realizado? '+isVisible);
			if( isVisible ){
			   // Acción si el elemento no es visible
			    posinifils = $("#prob1").find('option:selected').val();
				posinicols = $("#consec1").find('option:selected').val();
		...
		function fnRegla_3_4(parDoc, parApl, parEfe, parEva){
			...
			//if($('#clonmatriz').css('display') == 'none'){
			var isVisible = $("#clonmatriz").is(":visible");
			alert('visible Regla_3_4? '+isVisible);
			if( isVisible ){	
			   // Acción si el elemento no es visible
				posinifils = $("#prob1").find('option:selected').val();
				posinicols = $("#consec1").find('option:selected').val();
				...
				//var posinifils = $("#prob1").find('option:selected').val();
				//var posinicols = $("#consec1").find('option:selected').val();			   
			}
			
			fnMatRiesgo(moverbolita,posinifils,posinicols,moverfils,movercols,posicionesmover)
		}
		
		function fnMatRiesgo(p1,p2,p3,p4,p5,p6){
			var moverbolita = p1;
			var posinifils = p2;
			var posinicols = p3;
			var moverfils = p4;
			var movercols = p5;
			var posicionesmover = p6;
			if(moverbolita == 'N'){
				moverfils = 0;
				movercols = 0;
				posicionesmover =0 ;
			...
			{	
				//if($('#clonmatriz').css('display') == 'none'){
				var isVisible = $("#clonmatriz").is(":visible");
				alert('visible fn Matriz? '+isVisible);
				if( isVisible ){	
					posinifils = $("#prob1").find('option:selected').val();
					posinicols = $("#consec1").find('option:selected').val();					
				}
					...
					$.post("../curl/matriz/movs.php", {ck: <?php echo $CustomerKey; ?>, ruta : '../' }, function(posicion){
						$.each(posicion.body, function(i, item) {
					...
					alert('posinifils....'+posinifils+'   -  posinicols...'+posinicols);
				}
				
				var paramet = "ck="+<?php echo $_SESSION['Keyp']; ?>+"&pfila="+posinifils+"&pcols="+posinicols+"&pmoverfils="+moverfils+"&pmovercols="+movercols+"&pposicionmover="+posicionesmover+"&ruta=../";
				...
				$.ajax({
					...
					success: function(datos){
						...
						$("#matrizzControlR").hide();						
						$("#matcon").load(" #matcon");
						$("#matcon").show();
						//$("#matrizzControlR").show();
						$("#matrizz1ControlR").html(datos);
			...
			alert('moverbolita...'+moverbolita);
			alert('moverfils...'+moverfils);
			alert('movercols...'+movercols);
			alert('posicionesmover...'+posicionesmover);
