            ...
            <table class="table table-striped table-hover" style="font-size: 12px; color: #333; background-color: #FBFBFC;">          
                    ...
                    <tr>                                               
                        <td class='text-center'>
                         <div class="form-group"><button class="btn btn-secondary" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"><i class="material-icons">&#xE147;</i></button></div>
                        </td>                        
                        <td class='text-center' colspan="6">
                         <div class="form-group">
                            <select class="form-control" id="CausasName" name="CausasName" required>
