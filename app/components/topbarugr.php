      ...
      <nav class="navbar navbar-expand topbar mb-4 static-top shadow" style="background-color: <?php echo $reg['CustomerColor'];?>">
            <a href="index">
                <div ><img src="../img/as riesgos.png" style="max-width: 150px" ></div>
            </a>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="UGR6.php">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Ejemplo 1</div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="UGR2F.php">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Ejemplo 2</div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="UGR3.php">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Ejemplo 3</div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="UGR4.php">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Ejemplo 4</div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="UGR5.php">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Ejamplo 5</div>
