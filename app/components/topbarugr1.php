               <!-- Topbar -->
      <nav class="navbar navbar-expand topbar mb-4 static-top shadow" style="background-color: <?php echo $reg['CustomerColor'];?>">
            <a href="index">
                <div ><img src='img/<?php echo $reg['CustomerLogo'];?>' class="img-responsive"  border='0'/></div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <div style="font-size:12px;color: #fff"><i class="fab fa-artstation"></i> Pruebas </div>
                            </a>
                            <!-- Dropdown - Alerts -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="UGR1">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Ejeamplo 1</div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="UGR2F">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Ejamplo 2</div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="UGR3">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Ejamplo 3</div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="UGR4">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Ejamplo 4</div>
