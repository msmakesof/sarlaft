		  ...
		  var parametros = $(this).serialize();
			$.ajax({
				...
				success: function(datos){
					...
					if(msj == 'U'){
						type = 'success';
						txt = 'Categoría ha sido actualizada con éxito.';
					}
					else if(msj == 'E'){
						type= 'warning';
		...
		$( "#add_debilidades" ).submit(function( event ) {
			...
			$.ajax({
				type: "POST",
				url: "ajax/categoria/guardar.php",
				data: parametros,
				beforeSend: function(objeto){
					$("#resultados").html("Enviando...");
				},
				success: function(datos){
					...
					if(msj == 'O'){
						type = 'success';
						txt = 'Categoría ha sido guardada con éxito.';
					}
					else if(msj == 'E'){
						type= 'warning';
						txt = 'Ya existe un Registro grabado con el mismo Nombre.';
		  ...
		  var parametros = $(this).serialize();
			$.ajax({
				...
				success: function(datos){
					...
					if(msj == 'B'){
						type = 'success';
						txt = 'Categoría ha sido borrada con éxito.';
					}
					else if(msj == 'R'){
						type= 'error';
