		...
		$("#xpdf").on('click', function(event){
			...
			doc.autoTable({ 
				...
				columns: [
					{ header: ' ', dataKey: 'no' },
					{ header: 'DB', dataKey: 'CustomerDB' },
					{ header: 'Nombre', dataKey: 'CustomerName' },
					{ header: 'Ciudad', dataKey: 'CustomerCity' },
					{ header: 'Nit', dataKey: 'CustomerNit' },					
				],
				...
				didDrawPage: function (data) {					
					...
					doc.setFontSize(20);
					doc.setTextColor(40);
					doc.text("Reporte de Clientes", data.settings.margin.left+190, 40);
