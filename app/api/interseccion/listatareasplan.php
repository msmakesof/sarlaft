...
$items->TPP_CustomerKey = isset($_GET['ck']) ? $_GET['ck'] : die();
...
if($itemCount > 0){
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        $e = array(
			...
			"TPP_CustomerKey" => $TPP_CustomerKey
        );
    ...
    echo json_encode(
        array("message" => "Registro No Encontrado o No existen Tareas creadas para este Plan.")
    );
}
